...
function CaveBackground({ dragon }) {
  ...
  return (
    ...
    >
      ...
      {/* Moon with halo */}
      <circle cx="1400" cy="200" r="90" fill="#1a2545" opacity="0.4" />
      <circle cx="1400" cy="200" r="50" fill="#253560" opacity="0.5" />
      <circle cx="1400" cy="200" r="28" fill="#3a4a80" opacity="0.6" />
      <circle cx="1400" cy="200" r="15" fill="#5568a8" opacity="0.5" />
      {/* Stars — brighter, concentrated in sky opening */}
      {[
        [1280,100,2.2],[1350,60,1.8],[1420,40,2.5],[1500,90,1.5],[1560,55,2],
        [1300,180,1.5],[1450,250,2],[1550,190,1.3],[1320,310,1.5],[1520,330,1.8],
        [1280,260,1.2],[1400,370,1.8],[1560,300,1.5],[1350,420,1.2],[1500,440,1.5],
        [1340,500,2],[1560,470,1.2],[1280,560,1.5],[1460,580,1.8],[1380,640,1.3],
        [1520,140,1],[1440,480,1],[1300,430,1.3],[1480,350,1],[1550,520,1.2],
      ].map(([x,y,r], i) => (
        <circle key={`s${i}`} cx={x} cy={y} r={r} fill="#aabbee" opacity={0.3 + (i % 5) * 0.1} />
      ))}
      {/* Twinkling bright stars */}
      {[
        [1380,80,1.5],[1500,160,1.2],[1450,320,1.3],[1520,420,1],
      ].map(([x,y,r], i) => (
        <circle key={`bs${i}`} cx={x} cy={y} r={r} fill="#ddeeff" opacity={0.5 + (i % 3) * 0.1} />
      ))}
      {/* Treeline silhouette */}
      ...
      <path
        d={`M 1250 100
            Q 1230 160 1210 240 Q 1195 340 1192 440
            Q 1195 540 1210 640 Q 1230 740 1250 800
            Q 1350 800 1460 820 L 1600 860
            L 1600 30 Q 1500 45 1380 70 Q 1300 85 1250 100 Z`}
        fill="url(#sky-grad)"
      />
      {/* Soft feathered edge at the cave mouth — gradual dark-to-sky transition */}
      <path
        d={`M 1150 80
            Q 1130 150 1115 240 Q 1100 340 1098 440
            Q 1100 540 1115 640 Q 1130 740 1150 810
            L 1330 830 Q 1300 740 1285 640
            Q 1270 540 1268 440 Q 1270 340 1285 250
            Q 1300 170 1330 90 Z`}
        fill="#080810" opacity="0.4"
      />
      <path
        d={`M 1200 90
            Q 1180 170 1168 270 Q 1160 370 1158 450
            Q 1160 540 1170 640 Q 1188 730 1210 810
            L 1300 820 Q 1280 730 1265 640
            Q 1255 540 1255 450 Q 1258 360 1270 270
            Q 1285 180 1305 100 Z`}
